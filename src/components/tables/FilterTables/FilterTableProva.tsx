...
// Definizione della configurazione delle colonne
const userColumns: ColumnConfig<Payment>[] = [
  {
    key: "surname",
    label: "Cognome",
    sortable: true,
  ...
  },
  {
    ...
    sortable: true,
    filterType: "number",
    render: (user) => user.total_amount.toFixed(2) + " €",
  },
  {
    key: "id",
    label: "Azione",
...
export default function FilterTableUsersCollect() {
  return <FilterableTable data={tableData} columns={userColumns} />;
}
